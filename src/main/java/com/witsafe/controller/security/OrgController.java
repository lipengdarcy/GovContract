...
public class OrgController {
	...
	public String list(Model model, Page<SecOrg> page, HttpServletRequest request) {
	...
	public String update(SecOrg org, Integer parentOrgId) {
		if(parentOrgId != null && parentOrgId.longValue() > 0) {
			org.setParentOrg(parentOrgId);
		}
		//orgManager.save(org);

...
<script type="text/javascript">
	...
	if (document.getElementById("oaleft").style.display == "none") {
		...
		document.getElementById("leftimg").style.background = 'url(${ctx}/static/css/images/switch_left.gif)';
	} else {
		document.getElementById("oaleft").style.display = "none";
		document.getElementById("leftimg").style.background = 'url(${ctx}/static/css/images/switch_right.gif)';
	}
}
</script>
</body>
